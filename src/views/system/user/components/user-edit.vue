  ...
  <div>
    ...
    >
      <el-form ref="form" :model="form" label-width="120px" :rules="formRule" class="dialogForm">
        ...
        <div style="display: flex">
          <el-form-item ref="realName" label="姓名：" prop="realName">
            <el-input v-model="form.realName" :maxlength="50" class="formInput" />
          </el-form-item>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button v-if="!isAdd" type="danger" @click="handleDelete">删 除</el-button>
...
export default {
  ...
  data() {
    return {
      ...
      formRule: {
        loginName: !this.id ? [{ required: true, message: '请输入用户名' },
  ...
  methods: {
    ...
    async handleDelete() {
      await this.$parent.handleDelete(this.id)
      this.$emit('update:visible', false)
    }
  }
}
